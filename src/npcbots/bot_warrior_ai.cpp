...
public:
    ...
    struct warrior_botAI : public bot_ai
    {
        ...
        void Attack(uint32 diff)
        {
            ...
            if (IsSpellReady(INTERCEPT_1, diff, false) && !HasRole(BOT_ROLE_RANGED) && HasRole(BOT_ROLE_DPS) &&
                ...
                me->GetMotionMaster()->GetMotionSlotType(MOTION_SLOT_CONTROLLED) == NULL_MOTION_TYPE && //not charging
            ...
            if (IsSpellReady(SHIELD_SLAM_1, diff) && HasRole(BOT_ROLE_DPS) && CanBlock() &&
                ...
                Rand() < (75 + 200*(me->GetAuraEffect(SPELL_AURA_ADD_PCT_MODIFIER, SPELLFAMILY_WARRIOR, 2780, 0) != NULL)
        ...
        void ApplyClassDamageMultiplierMelee(uint32& /*damage*/, CalcDamageInfo& damageinfo) const
        {
            ...
            damageinfo.damage = damageinfo.damage * pctbonus;
        }
        ...
        void SpellHitTarget(Unit* target, SpellInfo const* spell)
        {
            ...
            if (baseId == OVERPOWER_1)
            {
                ...
                if (lvl >= 45 &&
                    ...
                    target->CastSpell(target, UNRELENTING_ASSAULT_SPELL, true, 0, 0, me->GetGUID());
            }
        ...
        void DamageDealt(Unit* victim, uint32& damage, DamageEffectType damageType)
        {
            ...
            {
                if (roll_chance_f(me->GetPPMProcChance(me->GetFloatValue(UNIT_FIELD_BASEATTACKTIME+BASE_ATTACK), 15.f, NULL)))
  ...
  /*Talent*/lvl >= 50 ? InitSpellMap(HEROIC_FURY_1) : RemoveSpell(HEROIC_FURY_1);
        ...
        void ApplyClassPassives() const
        {
            ...
            RefreshAura(DUAL_WIELD_SPECIALIZATION, level >= 40 ? 2 : level >= 25 ? 1 : 0);
            RefreshAura(IMPROVED_SPELL_REFLECTION, level >= 25 ? 1 : 0);
            RefreshAura(SWORD_SPEC5, level >= 60 ? 2 : level >= 34 ? 1 : 0);
            ...
            RefreshAura(IMPROVED_HAMSTRING, level >= 35 ? 2 : level >= 15 ? 1 : 0); //2 instead of glyph
