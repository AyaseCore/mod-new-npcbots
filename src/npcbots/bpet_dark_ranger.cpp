...
public:
    ...
    struct dark_ranger_botpetAI : public bot_pet_ai
    {
        ...
        void JustDied(Unit* u) { me->IsAIEnabled = false; me->setDeathState(JUST_DIED); me->ToTempSummon()->UnSummon(1000); bot_pet_ai::JustDied(u); }
        ...
        void DoPetActions(uint32 diff)
        {
            ...
            //    me->CastCustomSpell(me, SPELL_GENERATE_THREAT, &threat, NULL, NULL, true);
            //}
        }
